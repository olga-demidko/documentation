- Quick Navigation
  ...
  - [**Integrations**](guide/pipeline-integration/pipeline-integration.md)
    ...
    - [**CI Pipelines**](guide/pipeline-integration/pipe-management/pipelines-overview.md)
      ...
      - [Jenkins](#use-cases)
        - [Use Cases](guide/pipeline-integration/pipe-management/jenkins/use-cases.md)
      ...
      - [Travis CI](#use-cases)
        - [Use Cases](guide/pipeline-integration/pipe-management/travis/use-cases.md)
      ...
      - [GitLab](#use-cases)
        - [Use Cases](guide/pipeline-integration/pipe-management/gitlab/use-cases.md)
