  ...
  - [**Using the Nexploit Web UI**](guide/np-web-ui/np-web-ui.md)
    ...
    - [Advanced Setup and Configuration](guide/np-web-ui/advanced-set-up.md)
      ...
      - [Managing Access Scopes](guide/np-web-ui/advanced-set-up/managing-scopes/overview.md)
        - [Organization API Key Scopes](guide/np-web-ui/advanced-set-up/managing-scopes/organization-api.md)
        - [Personal API Key Scopes](guide/np-web-ui/advanced-set-up/managing-scopes/personal-api.md)
