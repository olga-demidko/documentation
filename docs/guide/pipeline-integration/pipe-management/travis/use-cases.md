...
You can either run the NexPloit CLI with the Repeater using the [NPM](guide/pipeline-integration/pipe-management/travis/examples.md) or by installing the existing [Docker image](guide/pipeline-integration/pipe-management/travis/examples.md) inside your pipeline. The Docker image comprises the NexPloit CLI and Repeater.  
 ...
 * If the scan target is accessible from the Internet:<br>
  ...
  ![two](../media/travis/2.png ':size=3%') From your pipeline [using the NexPloit CLI (NPM)](guide/pipeline-integration/pipe-management/travis/examples.md) 
