...
* [Running a Previously Run Scan – History, Retesting](guide/np-web-ui/scanning/reviewing-scans.md#scans-list-menu)
...
* [Setting Notifications Preferences](guide/np-web-ui/advanced-set-up/managing-personal-account#setting-your-notification-preferences)
