...
Advanced set up and configuration options are not mandatory for using NexPloit, unless you want to integrate NexPloit. The following options are provided for advanced setup and configuration of your NexPloit solution –
